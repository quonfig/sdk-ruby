...
class TestGetWeightedValues < Minitest::Test
  ...
  def test_weighted_value_is_consistent_1
    ...
    IntegrationTestHelpers.assert_resolved(resolver, 'feature-flag.weighted',
                                           { 'user' => { 'tracking_id' => 'a72c15f5' } }, 1)
  end
