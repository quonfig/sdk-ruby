...
class TestTelemetry < Minitest::Test
  ...
  def test_reason_is_static_for_config_with_no_targeting_rules
    ...
    IntegrationTestHelpers.assert_aggregator_post(self, aggregator, :evaluation_summary, [{ 'key' => 'brand.new.string', 'type' => 'CONFIG', 'value' => 'hello.world', 'value_type' => 'string', 'count' => 1, 'reason' => 1, 'selected_value' => { 'string' => 'hello.world' }, 'summary' => { 'config_row_index' => 0, 'conditional_value_index' => 0 } }], endpoint: '/api/v1/telemetry')
  end
  ...
  def test_reason_is_static_for_feature_flag_with_only_always_true_rules
    ...
    IntegrationTestHelpers.assert_aggregator_post(self, aggregator, :evaluation_summary, [{ 'key' => 'always.true', 'type' => 'FEATURE_FLAG', 'value' => true, 'value_type' => 'bool', 'count' => 1, 'reason' => 1, 'selected_value' => { 'bool' => true }, 'summary' => { 'config_row_index' => 0, 'conditional_value_index' => 0 } }], endpoint: '/api/v1/telemetry')
  end
  ...
  def test_reason_is_targeting_match_when_config_has_targeting_rules_but_evaluation_falls_through
    ...
    IntegrationTestHelpers.assert_aggregator_post(self, aggregator, :evaluation_summary, [{ 'key' => 'my-test-key', 'type' => 'CONFIG', 'value' => 'my-test-value', 'value_type' => 'string', 'count' => 1, 'reason' => 2, 'selected_value' => { 'string' => 'my-test-value' }, 'summary' => { 'config_row_index' => 0, 'conditional_value_index' => 1 } }], endpoint: '/api/v1/telemetry')
  end
  ...
  def test_reason_is_targeting_match_when_a_targeting_rule_matches
    ...
    IntegrationTestHelpers.assert_aggregator_post(self, aggregator, :evaluation_summary, [{ 'key' => 'feature-flag.integer', 'type' => 'FEATURE_FLAG', 'value' => 5, 'value_type' => 'int', 'count' => 1, 'reason' => 2, 'selected_value' => { 'int' => 5 }, 'summary' => { 'config_row_index' => 0, 'conditional_value_index' => 0 } }], endpoint: '/api/v1/telemetry')
  end
  ...
  def test_reason_is_targeting_match_for_feature_flag_fallthrough_with_targeting_rules
    ...
    IntegrationTestHelpers.assert_aggregator_post(self, aggregator, :evaluation_summary, [{ 'key' => 'feature-flag.integer', 'type' => 'FEATURE_FLAG', 'value' => 3, 'value_type' => 'int', 'count' => 1, 'reason' => 2, 'selected_value' => { 'int' => 3 }, 'summary' => { 'config_row_index' => 0, 'conditional_value_index' => 1 } }], endpoint: '/api/v1/telemetry')
  end
  ...
  def test_evaluation_summary_deduplicates_identical_evaluations
    ...
    IntegrationTestHelpers.assert_aggregator_post(self, aggregator, :evaluation_summary, [{ 'key' => 'brand.new.string', 'type' => 'CONFIG', 'value' => 'hello.world', 'value_type' => 'string', 'count' => 5, 'reason' => 1, 'selected_value' => { 'string' => 'hello.world' }, 'summary' => { 'config_row_index' => 0, 'conditional_value_index' => 0 } }], endpoint: '/api/v1/telemetry')
  end
  ...
  def test_selectedvalue_wraps_boolean_correctly
    ...
    IntegrationTestHelpers.assert_aggregator_post(self, aggregator, :evaluation_summary, [{ 'key' => 'brand.new.boolean', 'type' => 'CONFIG', 'value' => false, 'value_type' => 'bool', 'count' => 1, 'reason' => 1, 'selected_value' => { 'bool' => false }, 'summary' => { 'config_row_index' => 0, 'conditional_value_index' => 0 } }], endpoint: '/api/v1/telemetry')
  end
  ...
  def test_selectedvalue_wraps_int_correctly
    ...
    IntegrationTestHelpers.assert_aggregator_post(self, aggregator, :evaluation_summary, [{ 'key' => 'brand.new.int', 'type' => 'CONFIG', 'value' => 123, 'value_type' => 'int', 'count' => 1, 'reason' => 1, 'selected_value' => { 'int' => 123 }, 'summary' => { 'config_row_index' => 0, 'conditional_value_index' => 0 } }], endpoint: '/api/v1/telemetry')
  end
  ...
  def test_selectedvalue_wraps_double_correctly
    ...
    IntegrationTestHelpers.assert_aggregator_post(self, aggregator, :evaluation_summary, [{ 'key' => 'brand.new.double', 'type' => 'CONFIG', 'value' => 123.99, 'value_type' => 'double', 'count' => 1, 'reason' => 1, 'selected_value' => { 'double' => 123.99 }, 'summary' => { 'config_row_index' => 0, 'conditional_value_index' => 0 } }], endpoint: '/api/v1/telemetry')
  end
  ...
  def test_selectedvalue_wraps_string_list_correctly
    ...
    IntegrationTestHelpers.assert_aggregator_post(self, aggregator, :evaluation_summary, [{ 'key' => 'my-string-list-key', 'type' => 'CONFIG', 'value' => %w[a b c], 'value_type' => 'string_list', 'count' => 1, 'reason' => 1, 'selected_value' => { 'stringList' => %w[a b c] }, 'summary' => { 'config_row_index' => 0, 'conditional_value_index' => 0 } }], endpoint: '/api/v1/telemetry')
  end
  ...
  def test_context_shape_merges_fields_across_multiple_records
    ...
    IntegrationTestHelpers.assert_aggregator_post(self, aggregator, :context_shape, [{ 'name' => 'user', 'field_types' => { 'name' => 2, 'age' => 1, 'score' => 4 } }, { 'name' => 'team', 'field_types' => { 'name' => 2 } }], endpoint: '/api/v1/context-shapes')
  end
  ...
  def test_example_contexts_deduplicates_by_key_value
    ...
    IntegrationTestHelpers.assert_aggregator_post(self, aggregator, :example_contexts, { 'user' => { 'key' => 'user-123', 'name' => 'alice' } }, endpoint: '/api/v1/telemetry')
  end
  ...
  def test_telemetry_disabled_emits_nothing
    ...
    IntegrationTestHelpers.feed_aggregator(aggregator, :evaluation_summary, { 'keys' => ['brand.new.string'] }, contexts: {})
    IntegrationTestHelpers.assert_aggregator_post(self, aggregator, :evaluation_summary, nil, endpoint: '/api/v1/telemetry')
  end
  ...
  def test_shapes_only_mode_reports_shapes_but_not_examples
    ...
    IntegrationTestHelpers.assert_aggregator_post(self, aggregator, :context_shape, [{ 'name' => 'user', 'field_types' => { 'name' => 2, 'key' => 2 } }], endpoint: '/api/v1/context-shapes')
  end
  ...
  def test_empty_context_produces_no_context_telemetry
    ...
    IntegrationTestHelpers.assert_aggregator_post(self, aggregator, :context_shape, nil, endpoint: '/api/v1/context-shapes')
  end
  ...
  def test_confidential_plain_string_is_redacted_in_selectedvalue
    ...
    IntegrationTestHelpers.assert_aggregator_post(self, aggregator, :evaluation_summary, [{ 'key' => 'confidential.new.string', 'type' => 'CONFIG', 'value' => 'hello.world', 'value_type' => 'string', 'count' => 1, 'reason' => 1, 'selected_value' => { 'string' => '*****18aa7' }, 'summary' => { 'config_row_index' => 0, 'conditional_value_index' => 0 } }], endpoint: '/api/v1/telemetry')
  end
  ...
  def test_confidential_encrypted_string_is_redacted_using_ciphertext_hash
    ...
    IntegrationTestHelpers.assert_aggregator_post(self, aggregator, :evaluation_summary, [{ 'key' => 'a.secret.config', 'type' => 'CONFIG', 'value' => 'hello.world', 'value_type' => 'string', 'count' => 1, 'reason' => 1, 'selected_value' => { 'string' => '*****936c9' }, 'summary' => { 'config_row_index' => 0, 'conditional_value_index' => 0 } }], endpoint: '/api/v1/telemetry')
  end
end
