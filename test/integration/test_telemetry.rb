...
class TestTelemetry < Minitest::Test
  ...
  def test_selectedvalue_wraps_string_list_correctly
    ...
    IntegrationTestHelpers.assert_aggregator_post(self, aggregator, :evaluation_summary, [{"key" => "my-string-list-key", "type" => "CONFIG", "value" => ["a", "b", "c"], "value_type" => "string_list", "count" => 1, "reason" => 1, "selected_value" => {"stringList" => ["a", "b", "c"]}, "summary" => {"config_row_index" => 0, "conditional_value_index" => 0}}], endpoint: "/api/v1/telemetry")
  end
