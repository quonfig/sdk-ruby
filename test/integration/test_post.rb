...
class TestPost < Minitest::Test
  ...
  def test_reports_context_shape_aggregation
    ...
    IntegrationTestHelpers.feed_aggregator(aggregator, :context_shape, { 'user' => { 'name' => 'Michael', 'age' => 38, 'human' => true }, 'role' => { 'name' => 'developer', 'admin' => false, 'salary' => 15.75, 'permissions' => %w[read write] } }, contexts: {})
    IntegrationTestHelpers.assert_aggregator_post(self, aggregator, :context_shape, [{ 'name' => 'user', 'field_types' => { 'name' => 2, 'age' => 1, 'human' => 5 } }, { 'name' => 'role', 'field_types' => { 'name' => 2, 'admin' => 5, 'salary' => 4, 'permissions' => 10 } }], endpoint: '/api/v1/context-shapes')
  end
  ...
  def test_reports_example_contexts
    ...
    IntegrationTestHelpers.assert_aggregator_post(self, aggregator, :example_contexts, { 'user' => { 'name' => 'michael', 'age' => 38, 'key' => 'michael:1234' }, 'device' => { 'mobile' => false }, 'team' => { 'id' => 3.5 } }, endpoint: '/api/v1/telemetry')
  end
  ...
  def test_example_contexts_without_key_are_not_reported
    ...
    IntegrationTestHelpers.assert_aggregator_post(self, aggregator, :example_contexts, nil, endpoint: '/api/v1/telemetry')
  end
end
