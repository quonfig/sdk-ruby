...
class TestGetOrRaise < Minitest::Test
  ...
  def test_get_or_raise_raises_the_correct_error_if_it_doesn_t_raise_on_init_timeout
    IntegrationTestHelpers.assert_client_construction_raises(self, "any-key", 0.01, "https://app.staging-prefab.cloud", "return", "get_or_raise", Quonfig::Errors::MissingDefaultError)
  end
  ...
  def test_get_or_raise_can_raise_an_error_if_the_client_does_not_initialize_in_time
    IntegrationTestHelpers.assert_initialization_timeout_error(self, "any-key", 0.01, "https://app.staging-prefab.cloud", "raise")
  end
